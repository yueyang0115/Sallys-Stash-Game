...
public class ShapeAdapterTest {
  ...
  public void test_shapeadapter() {
    ...
    ShapeAdapter myadapter_4 = new ShapeAdapter(2, 2, 'G', 'R', myboard, 3);
    assertEquals(myadapter_4.getValid(), 0);

    BoardDrawer.drawOne(myboard);
    ShapeAdapter myadapter_5 = new ShapeAdapter(2, 4, 'G', 'V', myboard, 4);
    assertEquals(myadapter_5.getValid(), 1);

    ShapeAdapter myadapter_6 = new ShapeAdapter(5, 0, 'R', 'U', myboard, 4);
    assertEquals(myadapter_6.getValid(), 0);
    ShapeAdapter myadapter_7 = new ShapeAdapter(0, 9, 'R', 'R', myboard, 4);
    assertEquals(myadapter_7.getValid(), 0);
    ShapeAdapter myadapter_8 = new ShapeAdapter(19, 0, 'R', 'D', myboard, 4);
    assertEquals(myadapter_8.getValid(), 0);
    ShapeAdapter myadapter_9 = new ShapeAdapter(18, 9, 'R', 'L', myboard, 4);
    assertEquals(myadapter_9.getValid(), 0);

    ShapeAdapter myadapter_10 = new ShapeAdapter(4, 3, 'R', 'U', myboard, 4);
    myadapter_10.Create();
    ShapeAdapter myadapter_11 = new ShapeAdapter(4, 6, 'R', 'R', myboard, 4);
    myadapter_11.Create();
    ShapeAdapter myadapter_12 = new ShapeAdapter(9, 2, 'R', 'D', myboard, 4);
    myadapter_12.Create();
    ShapeAdapter myadapter_13 = new ShapeAdapter(9, 7, 'R', 'L', myboard, 4);
    myadapter_13.Create();
